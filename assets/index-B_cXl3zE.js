  ...
  return [createComponent(View, {
    ...
    get children() {
      return [createComponent(Text$1, {
        ...
        width: 360,
        fontSize: 20,
        children: "its just a poc/test using solidjs + webgl, not a stable version =p"
      }), createComponent(View, {
        y: -60,
        src: "./assets/watch-brasil.png",
        width: 300,
        height: 300
      })];
    }
...
const Container = makeComponentStyles(container$c);
const Content = makeComponentStyles(content);
const Text = makeComponentStyles(text$4);
const styles$1 = {
...
const Headline = (props) => createComponent(Text$1, mergeProps(props, {
